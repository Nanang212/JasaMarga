INSERT INTO "SELECT 
    ...
    CASE 
        ...
        ELSE STRING_AGG(ef.relation_status::text, ' & ')
    END AS family_data
FROM 
    ""Employees"" e
LEFT JOIN 
...
ORDER BY 
    e.id" (nik,"name",is_active,gender,age,school_name,"level",family_data) VALUES
	 ('11012','Budi',true,'Laki-Laki'::public."enum_EmployeeProfiles_gender",'27 Years Old','SMKN 7 Jakarta','SMA'::public."enum_Educations_level",'Istri & Anak & Anak'),
